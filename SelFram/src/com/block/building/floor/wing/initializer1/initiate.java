...
import com.block.building.floor.wing.initializer1.Initializer;
import com.block.building.floor.wing.initializer1.ReadExcelFile;
...
public class initiate {
  ...
  public void loginn() throws Exception {
	  ...
	  try {
		  readExcelFile.getUsernamePassword(GlobalVar.TestDataFilePath, GlobalVar.UserDetailsTestData, GlobalVar.SheetName, GlobalVar.Client, GlobalVar.Modules);
		} catch (IOException e) {
  ...
  public void beforeSuite(){
	  GlobalVar.report = new ExtentReports(GlobalVar.ExtentReportPath, true);
	 // GlobalVar.report.lo.loadConfig(new File( GlobalVar.ExtentReportConfigFilePath));
  }
  
  @BeforeMethod
  public void beforeMethod(Method method){
	  
	  GlobalVar.extLog = GlobalVar.report.startTest(this.getClass().getSimpleName() + ":: " + method.getName(), method.getName());
	 // GlobalVar.test.assignAuthor(GlobalVar.Requester);
	  GlobalVar.extLog.assignCategory(GlobalVar.TestType + "Client : " + GlobalVar.Client + "Environment : " + GlobalVar.Environment);	  
  }
}
