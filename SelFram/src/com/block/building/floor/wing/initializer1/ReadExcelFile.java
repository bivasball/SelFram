...
public class ReadExcelFile 
{
	...
	public String getUsernamePassword(String filePath, String fileName, String sheetName, String environment, String module) throws Exception
	{
		...
		for (int i = 0; i < rowCount + 1; i++)
		{
			...
			//System.out.println("Before Compare Environment value :" + environment + "  Module Value = " + module);
			//if (row.getCell(2).getStringCellValue().equals(environment) && row.getCell(3).getStringCellValue().equals(module)){
			...
			else 
			{
				...
				//System.out.println("Environment = " + xlsEnvironment + "   Module = " + xlsModule);
			}
